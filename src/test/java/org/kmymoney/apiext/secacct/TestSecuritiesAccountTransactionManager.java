...
public class TestSecuritiesAccountTransactionManager {
	...
	private void test01_check_persisted(File outFile) throws Exception {
		...
		assertEquals(DATE_POSTED, specTrxRO.getDatePosted());
		// .
		...
		assertEquals(NOF_STOCKS.doubleValue(), splt1.getSharesRat().doubleValue(), ConstTest.DIFF_TOLERANCE);
		assertEquals(NOF_STOCKS.longValue(), splt1.getSharesRat().getNumerator().longValue());
